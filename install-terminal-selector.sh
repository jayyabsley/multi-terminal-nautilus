...
# Terminal Selector Nautilus Extension Installer
# This script auto-detects installed terminals and lets you choose which ones to enable
...
echo "  2. Re-run this installer: ./install-terminal-selector.sh"
echo "  3. Uninstall: ./uninstall-terminal-selector.sh"
echo ""
